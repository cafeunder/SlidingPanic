...
const unsigned int PieceData::piece_property[] = {
	...
	FLAG_CAN_ENTER_UP | FLAG_CHANGE_UP | FLAG_BLOCK, // PIECE_UP_BLOCK
	FLAG_CAN_ENTER_RIGHT | FLAG_CHANGE_RIGHT | FLAG_BLOCK, // PIECE_RIGHT_BLOCK
	FLAG_CAN_ENTER_DOWN | FLAG_CHANGE_DOWN | FLAG_BLOCK, // PIECE_DOWN_BLOCK
	FLAG_CAN_ENTER_LEFT | FLAG_CHANGE_LEFT | FLAG_BLOCK, // PIECE_LEFT_BLOCK
