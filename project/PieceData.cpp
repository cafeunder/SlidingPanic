...
const unsigned int PieceData::piece_property[] = {
	...
	FLAG_CAN_ENTER_UP | FLAG_CHANGE_UP | FLAG_CENTER_BREAK | FLAG_BLOCK, // PIECE_UP_BLOCK
	FLAG_CAN_ENTER_RIGHT | FLAG_CHANGE_RIGHT | FLAG_CENTER_BREAK | FLAG_BLOCK, // PIECE_RIGHT_BLOCK
	FLAG_CAN_ENTER_DOWN | FLAG_CHANGE_DOWN | FLAG_CENTER_BREAK | FLAG_BLOCK, // PIECE_DOWN_BLOCK
	FLAG_CAN_ENTER_LEFT | FLAG_CHANGE_LEFT | FLAG_CENTER_BREAK | FLAG_BLOCK, // PIECE_LEFT_BLOCK
...
bool PieceData::CanThroughCenter(int piece_id) {
	return (PieceData::piece_property[piece_id] & FLAG_CENTER_BREAK) == 0;
}
